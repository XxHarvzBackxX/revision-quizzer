...
export function AccountPage({ navigate }: { navigate: Navigate }) {
  ...
  return <section className="account-page">
    ...
    <div className="account-grid">
      <article className="account-panel profile-panel"><div className="account-profile-heading"><AvatarBadge avatar={avatar} size="large" /><div><strong>@{activeAccount.handle}</strong><span>{activeAccount.email}</span>{activeAccount.admin && <small>Administrator</small>}</div></div>
