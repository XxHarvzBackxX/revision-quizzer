...
function PrivacyPolicy({ navigate }: { navigate: Navigate }) {
  ...
  return <LegalShell title="Privacy Policy" updated="22 July 2026" navigate={navigate}>
    ...
    <h2>Retention</h2><p>Account data is retained while the account is active. After 23 months of inactivity, Quiz Arcade emails a warning. Signing in cancels deletion. At 24 months, the account and progress are deleted and approved community sets are anonymized. Voluntary deletion lets you anonymize or delete approved sets. Provider backups may take additional time to expire under the processors’ published schedules.</p>
    <h2>Your choices and rights</h2><p>You can update your profile, control attribution, download a JSON export, and delete the account from the Account page. You may also contact Harvey Wells to request access, correction, restriction, objection, portability, or erasure. UK users may complain to the Information Commissioner’s Office.</p>
...
function Guidelines({ navigate }: { navigate: Navigate }) {
  return <LegalShell title="Community Guidelines" updated="22 July 2026" navigate={navigate}>
    ...
    <h2>Moderation</h2><p>Submissions may wait for review. Quiz Arcade may reject, unpublish, or remove content that breaks these rules. Contact <a href="mailto:harvey.wells.07@gmail.com">harvey.wells.07@gmail.com</a> to report a set or challenge a moderation decision.</p>
